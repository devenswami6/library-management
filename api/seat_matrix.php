<?php
// api/seat_matrix.php - Real-time seat availability matrix endpoint (Admin Restricted)
...
if (!$is_admin_user) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'ACCESS DENIED: Visual Seat Matrix is restricted to Admin access only.'
    ]);
    exit();
}
